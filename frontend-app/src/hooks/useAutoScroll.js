...
/**
 * Custom hook for auto-scrolling chat messages
 * Automatically scrolls to bottom when new messages arrive
 * Disables auto-scroll when user manually scrolls up
 * 
 * @param {Object} options - Configuration options
 * @param {number} options.offset - Distance from bottom to consider "at bottom" (default: 20)
 * @param {boolean} options.smooth - Whether to use smooth scrolling (default: false)
 * @param {Array} options.content - Content array to watch for changes
